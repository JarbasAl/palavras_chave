...
from palavras_chave.res.nyumaya.libnyumaya import NyumayaDetector, \
    FeatureExtractor


class NyumayaWakeWord(HotWordEngine):
    """Nyumaya Wake Word"""

    def __init__(self, hotword="nyumaya_legacy", config=None, lang="en-us"):
        config = config or {}
        super(NyumayaWakeWord, self).__init__(hotword, config, lang)
